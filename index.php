            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="rekap_spm.php">Rekapitulasi Realisasi <br> Standar Pelayanan <br>
                            Minimal (SPM)</a>
                        <a class="collapse-item" href="rekap_ppke.php">Rekapitulasi Realisasi<br /> Percepatan
                            Penghapusan <br> Kemiskinan Ekstrem</a>
                    </div>
                </div>
            </li>
